...
import { Configuration, DefaultConfig, DataplaneApi, ResultSet, StatementStatusFromJSON, ResponseError } from "./dpapiv2"
...
export class DPAPIConnection implements StatementHandler {
    ...
    constructor(dsn: string, token: string, timezone: string, sessionID?: string) {
