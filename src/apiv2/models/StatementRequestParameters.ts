...
export function StatementRequestParametersFromJSON(json: any): StatementRequestParameters {
    return StatementRequestParametersFromJSONTyped(json, false);
}

export function StatementRequestParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatementRequestParameters {
...
export function StatementRequestParametersToJSON(value?: StatementRequestParameters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
