...
export interface StatementRequest {
    ...
    schema?: string;
    /**
     * Store to use when executing a statement. This value is case sensitive
     * @type {string}
     * @memberof StatementRequest
     */
    store?: string;
    /**
     * Compute_pool to use when executing a statement. This value is case sensitive
     * @type {string}
     * @memberof StatementRequest
     */
    computePool?: string;
...
export function StatementRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatementRequest {
    ...
    return {
        ...
        'computePool': !exists(json, 'computePool') ? undefined : json['computePool'],
        'parameters': !exists(json, 'parameters') ? undefined : StatementRequestParametersFromJSON(json['parameters']),
    };
}
