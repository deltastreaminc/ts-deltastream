...
export function ResultSetMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultSetMetadata {
    ...
    return {
        ...
        'partitionInfo': !exists(json, 'partitionInfo') ? [] : (json['partitionInfo'] as Array<any>).map(ResultSetPartitionInfoFromJSON),
        'columns': !exists(json, 'columns') ? [] : (json['columns'] as Array<any>).map(ResultSetColumnsInnerFromJSON),
        'dataplaneRequest': !exists(json, 'dataplaneRequest') ? undefined : DataplaneRequestFromJSON(json['dataplaneRequest']),
