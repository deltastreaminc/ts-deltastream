...
export type DataplaneRequestRequestTypeEnum =
  (typeof DataplaneRequestRequestTypeEnum)[keyof typeof DataplaneRequestRequestTypeEnum];
...
export function DataplaneRequestFromJSONTyped(
  json: any,
