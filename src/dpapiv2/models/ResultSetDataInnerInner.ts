...
export function ResultSetDataInnerInnerFromJSON(
  json: any
): ResultSetDataInnerInner {
  return ResultSetDataInnerInnerFromJSONTyped(json, false);
}

export function ResultSetDataInnerInnerFromJSONTyped(
  json: any,
...
export function ResultSetDataInnerInnerToJSON(
  value?: ResultSetDataInnerInner | null
): any {
  return value;
}
