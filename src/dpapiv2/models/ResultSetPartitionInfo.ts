...
export function ResultSetPartitionInfoFromJSON(
  json: any
): ResultSetPartitionInfo {
  return ResultSetPartitionInfoFromJSONTyped(json, false);
}

export function ResultSetPartitionInfoFromJSONTyped(
  json: any,
...
export function ResultSetPartitionInfoToJSON(
  value?: ResultSetPartitionInfo | null
): any {
  if (value === undefined) {
    return undefined;
  }
