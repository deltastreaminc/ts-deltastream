...
const singleResponsePartition0 = {
    ...
    "data": [
        ["0e0e3617-3cd6-4407-a189-97daf226c4d4", "o1", null, null, "2023-12-30 03:37:45Z"]
    ]
};
...
const multiResponsePartition0 = {
    ...
    "data": [
        ["0e0e3617-3cd6-4407-a189-97daf226c4d4", "o1", null, null, "2023-12-30 03:37:45Z"],
        ["fa58cd4d-5c17-466a-97f4-0fc8b0adc2ca", "o2", null, null, "2023-12-30 03:37:45Z"]
    ]
};
...
const multiResponsePartition1 = {
    ...
    "data": [
        ["776d2269-63f9-4bff-af48-1d2bc4184c29", "o3", null, null, "2023-12-30 03:37:45Z"],
        ["c88d1c56-c33b-419b-8390-f11ba7f529ca", "o4", null, null, "2023-12-30 03:37:45Z"]
    ]
};
...
const dataTypesResponse = {
    ...
    "metadata": {
        ...
        "columns": [
            ...
            { "name": "STRUCT", "type": "STRUCT<k VARCHAR, v VARCHAR>", "nullable": false },
            ...
            { "name": "MAP_NULLABLE", "type": "MAP<VARCHAR, VARCHAR>", "nullable": true },
            { "name": "STRUCT_NULLABLE", "type": "STRUCT<k VARCHAR, v VARCHAR>", "nullable": true },
            { "name": "BOOLEAN_NULLABLE", "type": "BOOLEAN", "nullable": true }
        ],
        "context": {}
    },
    "data": [
        ["VARCHAR", "255", "32767", "2147483647", "9223372036854775807", "-1.79E+308", "-1.79E+308", "123.00", "2007-04-30 13:10:02.0474381", "2007-04-30 13:10:02.0474381Z", "2007-04-30", "13:10:02.0474381", "2007-04-30 13:10:02.0474381Z", "YmluYXJ5", "YmluYXJ5", "[1,2,3,4]", "{\"k\": \"v\"}", "{\"k\": \"v\"}", "true", "VARCHAR", "255", "32767", "2147483647", "9223372036854775807", "-1.79E+308", "-1.79E+308", "123.00", "2007-04-30 13:10:02.0474381", "2007-04-30 13:10:02.0474381Z", "2007-04-30", "13:10:02.0474381", "2007-04-30 13:10:02.0474381Z", "YmluYXJ5", "YmluYXJ5", "[1,2,3,4]", "{\"k\": \"v\"}", "{\"k\": \"v\"}", "true"],
...
export const handlers = [
    ...
    http.post('https://api.deltastream.io/v2/statements', async (r) => {
        ...
        const stmtReq = JSON.parse(await body.get('request')?.text()) as StatementRequest;
        switch (stmtReq.statement) {
            case `DELAYED SINGLE PARTITION WITH ONE ROW;`:
                return HttpResponse.json(delayedSingleResponsePartition0, { status: 202 });
            ...
            case `TEST ATTACHMENT;`: {
                ...
                if (attachments.length !== 1) {
                    return HttpResponse.json({ message: 'expected 1 attachment' }, { status: 500 });
                }
                if ((await attachments[0].text()) !== blobData) {
                    return HttpResponse.json({ message: 'bob content does not match' }, { status: 500 });
                }
                return HttpResponse.json(noRowsResponse);
            }
            case `ALL DATA TYPES;`: {
            ...
            default:
                return HttpResponse.json({ message: 'unknown statement' }, { status: 500 });
        }
    }),

    http.get('https://api.deltastream.io/v2/statements/:statementId', async (r) => {
        if (r.request.headers.get('authorization') !== "Bearer sometoken") {
            return HttpResponse.json({ message: 'no token' }, { status: 401 });
        }
            ...
            case `d789687d-4e1b-4649-846e-4f10b722f3ad`: {
                ...
                switch (partition) {
                    case '0':
                        return HttpResponse.json(singleResponsePartition0);
                    default:
                        return HttpResponse.json({ message: 'unknown partition' }, { status: 500 });
                }
            }
